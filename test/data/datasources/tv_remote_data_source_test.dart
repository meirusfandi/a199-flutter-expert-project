...
void main() {
  const API_KEY = 'api_key=233b568bea8fb27357da8dd3df2fc37f';
  ...
  group('get Airing Today Tvs', () {
    final tTvList = TvResponse.fromJson(
            json.decode(readJson('dummy_data/tv/airing_today.json'))).tvList;
  ...
  group('get Popular Tvs', () {
    final tTvList =
        TvResponse.fromJson(json.decode(readJson('dummy_data/tv/popular_tv.json'))).tvList;
